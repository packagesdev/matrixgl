...
void initScene(sceneSettings * inSceneSettings);

int cbRenderScene(sceneSettings * inSceneSettings);

int make_change(sceneSettings * inSceneSettings);

void make_text(void);
void draw_char(int mode, long num, float light, float x, float y, float z);
void draw_flare(float x,float y,float z);
void draw_text1(sceneSettings * inSceneSettings);
void draw_text2(int mode,sceneSettings * inSceneSettings);
int scrollScene(int mode,sceneSettings * inSceneSettings);
...
void ourInit(int Width,int Height,sceneSettings * inSceneSettings);
